...
- [Try on Other Sites](docs/TRY_ON_OTHER_SITES.md): the reusable-config walkthrough for script tag install plus Helper, Console, and Bookmarklet testing flows.
